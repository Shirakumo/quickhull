      ...
      (case num-vertices
        ...
        ((3 4)
         (let* ((plane (plane (triangle-normal vertices 0 1 2) (v vertices 0)))
                (last-vertex (min 3 (1- num-vertices)))
                (height (height-above-plane vertices last-vertex plane)))
           (cond #+TODO ((= height 0)   ; TODO eps2
                         (error "Mesh has no volume. Not enough points to form a triangle."))
                 ((> height 0)
                  (values (make-mesh-builder 1 0 2 last-vertex) vertices))
                 (t                     ; (< height 0)
                  (values (make-mesh-builder 0 1 2 last-vertex) vertices)))))
        (T
